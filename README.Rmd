...
The goal of this R package is to provide functionalists to design and evaluate panels. 
...
### Install this package from this GitHub
...
remotes::install_github("TRON-Private/paneldesign")
```
