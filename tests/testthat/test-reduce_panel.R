...
test_that("reduce_panel works with multiple overlapping exons with differnt strands", {
  ...
  # expect same ranges for r and reduced(r)
  expect_equal(length(r), length(GenomicRanges::reduce(r)))
